// surveyForms/jobsForm.js
export const jobsFormJson = {
    pages: [
        {
            name: "page1",
            elements: [
                {
                    type: "html",
                    name: "customGreeting",
                    html: "<div class='greeting-container'><img src='./assets/avatar_image.png' alt='Person' class='greeting-image'/><div class='greeting-bubble'>Please provide details for your current or latest job.</div></div>",
                },
                {
                    type: "dropdown",
                    name: "designation1",
                ...
                },
                {
                    ...
                    inputType: "date",
                    isRequired: true,
                    visibleIf: "{isCurrent1} = false" // Only show end date if not current job
                },
                {
                    type: "comment",
            ...
            elements: [
                {
                    type: "html",
                    name: "customGreeting",
                    html: "<div class='greeting-container'><img src='./assets/avatar_image.png' alt='Person' class='greeting-image'/><div class='greeting-bubble'>Please provide details for one of your previous jobs.</div></div>",
                },
    ...
    completedHtml: `
      <div class="greeting-container">
        ...
        <div class="greeting-bubble">
          <p>Thank you for submitting your job details!</p>
